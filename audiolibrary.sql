...
CREATE VIEW TotalSongsStatisticsVIEW AS WITH songsstatisticsasc AS(SELECT `Music artist/band`.artband, Song.nam, Song.dur FROM `Music artist/band` JOIN `Music artist/band's song` ON `Music artist/band`.ID=`Music artist/band's song`.artband JOIN Song ON Song.ID=`Music artist/band's song`.song UNION SELECT `Related music artist/band`.relartband, Song.nam, Song.dur FROM `Related music artist/band` JOIN `Music artist/band's song` ON `Related music artist/band`.ID=`Music artist/band's song`.artband JOIN Song ON Song.ID=`Music artist/band's song`.song) SELECT CONCAT(songsstatisticsasc.artband, ' - ', songsstatisticsasc.nam, ' (', TRIM(LEADING '00:' FROM REPLACE(songsstatisticsasc.dur, ':0', ':')), ')') AS 'Shortest songs', CONCAT(songsstatisticsdesc.artband, ' - ', songsstatisticsdesc.nam, ' (', TRIM(LEADING '00:' FROM REPLACE(songsstatisticsdesc.dur, ':0', ':')), ')') AS 'Longest songs' FROM (SELECT *, ROW_NUMBER() OVER(ORDER BY dur) AS rnasc FROM songsstatisticsasc) AS songsstatisticsasc JOIN (SELECT *, ROW_NUMBER() OVER(ORDER BY dur DESC) AS rndesc FROM songsstatisticsasc) AS songsstatisticsdesc ON songsstatisticsasc.rnasc=songsstatisticsdesc.rndesc;
...
BEGIN
WITH songsstatisticsasc AS(SELECT `Music artist/band`.artband, Song.nam, Song.dur FROM `Music artist/band` JOIN `Music artist/band's song` ON `Music artist/band`.ID=`Music artist/band's song`.artband JOIN Song ON Song.ID=`Music artist/band's song`.song WHERE `Music artist/band`.cat='Жанр' AND Song.cat IS NULL UNION SELECT `Related music artist/band`.relartband, Song.nam, Song.dur FROM `Related music artist/band` JOIN `Music artist/band` ON `Music artist/band`.ID=`Related music artist/band`.artband JOIN `Music artist/band's song` ON `Related music artist/band`.ID=`Music artist/band's song`.artband JOIN Song ON Song.ID=`Music artist/band's song`.song WHERE `Music artist/band`.cat='Жанр' AND Song.cat IS NULL) SELECT CONCAT(songsstatisticsasc.artband, ' - ', songsstatisticsasc.nam, ' (', TRIM(LEADING '00:' FROM REPLACE(songsstatisticsasc.dur, ':0', ':')), ')') AS 'Shortest songs', CONCAT(songsstatisticsdesc.artband, ' - ', songsstatisticsdesc.nam, ' (', TRIM(LEADING '00:' FROM REPLACE(songsstatisticsdesc.dur, ':0', ':')), ')') AS 'Longest songs' FROM (SELECT *, ROW_NUMBER() OVER(ORDER BY dur) AS rnasc FROM songsstatisticsasc) AS songsstatisticsasc JOIN (SELECT *, ROW_NUMBER() OVER(ORDER BY dur DESC) AS rndesc FROM songsstatisticsasc) AS songsstatisticsdesc ON songsstatisticsasc.rnasc=songsstatisticsdesc.rndesc;
END$
CREATE PROCEDURE SongsStatisticsGenre(genre varchar(50))
BEGIN
SET @genr=genre;
WITH songsstatisticsasc AS(SELECT `Music artist/band`.artband, Song.nam, Song.dur FROM `Music artist/band` JOIN `Music artist/band's song` ON `Music artist/band`.ID=`Music artist/band's song`.artband JOIN Song ON Song.ID=`Music artist/band's song`.song WHERE `Music artist/band`.genr=@genr AND Song.cat IS NULL UNION SELECT `Related music artist/band`.relartband, Song.nam, Song.dur FROM `Related music artist/band` JOIN `Music artist/band` ON `Music artist/band`.ID=`Related music artist/band`.artband JOIN `Music artist/band's song` ON `Related music artist/band`.ID=`Music artist/band's song`.artband JOIN Song ON Song.ID=`Music artist/band's song`.song WHERE `Music artist/band`.genr=@genr AND Song.cat IS NULL) SELECT CONCAT(songsstatisticsasc.artband, ' - ', songsstatisticsasc.nam, ' (', TRIM(LEADING '00:' FROM REPLACE(songsstatisticsasc.dur, ':0', ':')), ')') AS 'Shortest songs', CONCAT(songsstatisticsdesc.artband, ' - ', songsstatisticsdesc.nam, ' (', TRIM(LEADING '00:' FROM REPLACE(songsstatisticsdesc.dur, ':0', ':')), ')') AS 'Longest songs' FROM (SELECT *, ROW_NUMBER() OVER(ORDER BY dur) AS rnasc FROM songsstatisticsasc) AS songsstatisticsasc JOIN (SELECT *, ROW_NUMBER() OVER(ORDER BY dur DESC) AS rndesc FROM songsstatisticsasc) AS songsstatisticsdesc ON songsstatisticsasc.rnasc=songsstatisticsdesc.rndesc;
END$
CREATE PROCEDURE SongsStatisticsComposers()
BEGIN
WITH songsstatisticsasc AS(SELECT `Music artist/band`.artband, Song.nam, Song.dur FROM `Music artist/band` JOIN `Music artist/band's song` ON `Music artist/band`.ID=`Music artist/band's song`.artband JOIN Song ON Song.ID=`Music artist/band's song`.song WHERE `Music artist/band`.cat='Композиторы' AND Song.cat IS NULL) SELECT CONCAT(songsstatisticsasc.artband, ' - ', songsstatisticsasc.nam, ' (', TRIM(LEADING '00:' FROM REPLACE(songsstatisticsasc.dur, ':0', ':')), ')') AS 'Shortest songs', CONCAT(songsstatisticsdesc.artband, ' - ', songsstatisticsdesc.nam, ' (', TRIM(LEADING '00:' FROM REPLACE(songsstatisticsdesc.dur, ':0', ':')), ')') AS 'Longest songs' FROM (SELECT *, ROW_NUMBER() OVER(ORDER BY dur) AS rnasc FROM songsstatisticsasc) AS songsstatisticsasc JOIN (SELECT *, ROW_NUMBER() OVER(ORDER BY dur DESC) AS rndesc FROM songsstatisticsasc) AS songsstatisticsdesc ON songsstatisticsasc.rnasc=songsstatisticsdesc.rndesc;
END$
CREATE PROCEDURE SongsStatisticsBloggers()
WITH songsstatisticsasc AS(SELECT `Music artist/band`.artband, Song.nam, Song.dur FROM `Music artist/band` JOIN `Music artist/band's song` ON `Music artist/band`.ID=`Music artist/band's song`.artband JOIN Song ON Song.ID=`Music artist/band's song`.song WHERE `Music artist/band`.cat='Блогеры' AND Song.cat IS NULL) SELECT CONCAT(songsstatisticsasc.artband, ' - ', songsstatisticsasc.nam, ' (', TRIM(LEADING '00:' FROM REPLACE(songsstatisticsasc.dur, ':0', ':')), ')') AS 'Shortest songs', CONCAT(songsstatisticsdesc.artband, ' - ', songsstatisticsdesc.nam, ' (', TRIM(LEADING '00:' FROM REPLACE(songsstatisticsdesc.dur, ':0', ':')), ')') AS 'Longest songs' FROM (SELECT *, ROW_NUMBER() OVER(ORDER BY dur) AS rnasc FROM songsstatisticsasc) AS songsstatisticsasc JOIN (SELECT *, ROW_NUMBER() OVER(ORDER BY dur DESC) AS rndesc FROM songsstatisticsasc) AS songsstatisticsdesc ON songsstatisticsasc.rnasc=songsstatisticsdesc.rndesc;
BEGIN
END$
CREATE PROCEDURE SongsStatisticsCovers()
WITH songsstatisticsasc AS(SELECT `Music artist/band`.artband, Song.nam, Song.dur FROM `Music artist/band` JOIN `Music artist/band's song` ON `Music artist/band`.ID=`Music artist/band's song`.artband JOIN Song ON Song.ID=`Music artist/band's song`.song WHERE Song.cat='Каверы' UNION SELECT `Related music artist/band`.relartband, Song.nam, Song.dur FROM `Related music artist/band` JOIN `Music artist/band` ON `Music artist/band`.ID=`Related music artist/band`.artband JOIN `Music artist/band's song` ON `Related music artist/band`.ID=`Music artist/band's song`.artband JOIN Song ON Song.ID=`Music artist/band's song`.song WHERE Song.cat='Каверы') SELECT CONCAT(songsstatisticsasc.artband, ' - ', songsstatisticsasc.nam, ' (', TRIM(LEADING '00:' FROM REPLACE(songsstatisticsasc.dur, ':0', ':')), ')') AS 'Shortest songs', CONCAT(songsstatisticsdesc.artband, ' - ', songsstatisticsdesc.nam, ' (', TRIM(LEADING '00:' FROM REPLACE(songsstatisticsdesc.dur, ':0', ':')), ')') AS 'Longest songs' FROM (SELECT *, ROW_NUMBER() OVER(ORDER BY dur) AS rnasc FROM songsstatisticsasc) AS songsstatisticsasc JOIN (SELECT *, ROW_NUMBER() OVER(ORDER BY dur DESC) AS rndesc FROM songsstatisticsasc) AS songsstatisticsdesc ON songsstatisticsasc.rnasc=songsstatisticsdesc.rndesc;
BEGIN
END$
CREATE PROCEDURE SongsStatisticsSoundtracks()
WITH soundtracksstatisticsasc AS(SELECT movanimsergam, nosongs, songsdur FROM Soundtrack) SELECT CONCAT(soundtracksstatisticsasc.movanimsergam, ' (', soundtracksstatisticsasc.nosongs, ', ', TRIM(LEADING '00:' FROM REPLACE(soundtracksstatisticsasc.songsdur, ':0', ':')), ')') AS 'Shortest soundtrack', CONCAT(soundtracksstatisticsdesc.movanimsergam, ' (', soundtracksstatisticsdesc.nosongs, ', ', TRIM(LEADING '0' FROM TRIM(LEADING '00:' FROM REPLACE(soundtracksstatisticsdesc.songsdur, ':0', ':'))), ')') AS 'Longest soundtrack' FROM (SELECT *, ROW_NUMBER() OVER(ORDER BY songsdur) AS rnasc FROM soundtracksstatisticsasc) AS soundtracksstatisticsasc JOIN (SELECT *, ROW_NUMBER() OVER(ORDER BY songsdur DESC) AS rndesc FROM soundtracksstatisticsasc) AS soundtracksstatisticsdesc ON soundtracksstatisticsasc.rnasc=soundtracksstatisticsdesc.rndesc;
BEGIN
END$
