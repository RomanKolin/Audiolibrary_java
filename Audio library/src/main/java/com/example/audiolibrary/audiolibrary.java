                                ...
                                try
                                {
                                    ...
                                    if (textfield1.getText().equals("Композиторы"))
                                    {
                                        ...
                                        if (textfield4.getText().contains("d"))
                                            ...
                                            label27artistsandsongsstatistics.setText(("\nAverage songs count/duration per artist; average song duration: " + String.format("%.2f", Double.parseDouble(textfield3.getText())/Double.parseDouble(textfield2.getText())) + "/" + (int)((Double.parseDouble(textfield4.getText().substring(0, textfield4.getText().indexOf(':')))*3600+Double.parseDouble(textfield4.getText().substring(textfield4.getText().indexOf(':')+1, textfield4.getText().lastIndexOf(':')))*60+Double.parseDouble(textfield4.getText().substring(textfield4.getText().lastIndexOf(':')+1)))/Double.parseDouble(textfield2.getText()))/60 + ":" + ((Integer.parseInt(textfield4.getText().substring(0, textfield4.getText().indexOf(':')))*3600+Integer.parseInt(textfield4.getText().substring(textfield4.getText().indexOf(':')+1, textfield4.getText().lastIndexOf(':')))*60+Integer.parseInt(textfield4.getText().substring(textfield4.getText().lastIndexOf(':')+1)))/Integer.parseInt(textfield2.getText()))%60 + ":" + String.format("%.3f", (((Double.parseDouble(textfield4.getText().substring(0, textfield4.getText().indexOf(':')))*3600+Double.parseDouble(textfield4.getText().substring(textfield4.getText().indexOf(':')+1, textfield4.getText().lastIndexOf(':')))*60+Double.parseDouble(textfield4.getText().substring(textfield4.getText().lastIndexOf(':')+1)))/Double.parseDouble(textfield2.getText()))%1)).substring(2) + "; " + (int)((Double.parseDouble(textfield4.getText().substring(0, textfield4.getText().indexOf(':')))*3600+Double.parseDouble(textfield4.getText().substring(textfield4.getText().indexOf(':')+1, textfield4.getText().lastIndexOf(':')))*60+Double.parseDouble(textfield4.getText().substring(textfield4.getText().lastIndexOf(':')+1)))/Double.parseDouble(textfield3.getText()))/60 + ":" + ((Integer.parseInt(textfield4.getText().substring(0, textfield4.getText().indexOf(':')))*3600+Integer.parseInt(textfield4.getText().substring(textfield4.getText().indexOf(':')+1, textfield4.getText().lastIndexOf(':')))*60+Integer.parseInt(textfield4.getText().substring(textfield4.getText().lastIndexOf(':')+1)))/Integer.parseInt(textfield3.getText()))%60 + ":" + String.format("%.3f", (((Double.parseDouble(textfield4.getText().substring(0, textfield4.getText().indexOf(':')))*3600+Double.parseDouble(textfield4.getText().substring(textfield4.getText().indexOf(':')+1, textfield4.getText().lastIndexOf(':')))*60+Double.parseDouble(textfield4.getText().substring(textfield4.getText().lastIndexOf(':')+1)))/Double.parseDouble(textfield3.getText()))%1)).substring(2)).replace("0/", "/"));
                                    }
                                    ...
                                    else if (textfield1.getText().equals("Саундтреки"))
                                    {
                                        ...
                                        if (textfield4.getText().contains("d"))
                                            ...
                                            label27artistsandsongsstatistics.setText("\nAverage song duration: " + (int)((Double.parseDouble(textfield4.getText().substring(0, textfield4.getText().indexOf(':')))*3600+Double.parseDouble(textfield4.getText().substring(textfield4.getText().indexOf(':')+1, textfield4.getText().lastIndexOf(':')))*60+Double.parseDouble(textfield4.getText().substring(textfield4.getText().lastIndexOf(':')+1)))/Double.parseDouble(textfield3.getText()))/60 + ":" + ((Integer.parseInt(textfield4.getText().substring(0, textfield4.getText().indexOf(':')))*3600+Integer.parseInt(textfield4.getText().substring(textfield4.getText().indexOf(':')+1, textfield4.getText().lastIndexOf(':')))*60+Integer.parseInt(textfield4.getText().substring(textfield4.getText().lastIndexOf(':')+1)))/Integer.parseInt(textfield3.getText()))%60 + ":" + String.format("%.3f", (((Double.parseDouble(textfield4.getText().substring(0, textfield4.getText().indexOf(':')))*3600+Double.parseDouble(textfield4.getText().substring(textfield4.getText().indexOf(':')+1, textfield4.getText().lastIndexOf(':')))*60+Double.parseDouble(textfield4.getText().substring(textfield4.getText().lastIndexOf(':')+1)))/Double.parseDouble(textfield3.getText()))%1)).substring(2));
                                    }
                                    tableview4songsstatistics.setItems(songsstatisticsobslist);
                                }
                                catch (Exception ex)
